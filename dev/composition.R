...
metadata = readRDS("~/PostDoc/cellNexus/dev/metadata_annotated.rds")
...
cell_metadata_with_harmonised_annotation = readRDS("~/PostDoc/cellNexus/dev/cell_metadata_with_harmonised_annotation.rds")
...
# 		)
#
# 	res_absolute |> saveRDS("~/PostDoc/cellNexus/dev/immune_non_immune_differential_composition.rds")
#
# })

res_absolute = readRDS("~/PostDoc/cellNexus/dev/immune_non_immune_differential_composition.rds")
...
data_for_immune_proportion_relative = readRDS("~/PostDoc/cellNexus/dev/data_for_immune_proportion_relative.rds")
...
res_relative = readRDS("~/PostDoc/cellNexus/dev/immune_non_immune_differential_composition_relative_5.rds")

# job::job({
# 	readRDS("~/PostDoc/cellNexus/dev/immune_non_immune_differential_composition_relative_5.rds") |>
# 		remove_unwanted_variation(~ 0 + tissue_harmonised) |>
# 		saveRDS("~/PostDoc/cellNexus/dev/proportions_tissue_adjusted_5.rds")
# })
# job::job({ readRDS("~/PostDoc/cellNexus/dev/immune_non_immune_differential_composition_relative_4.rds") |> remove_unwanted_variation(~ age_days) })


proportions_tissue_replicate = readRDS("~/PostDoc/cellNexus/dev/immune_non_immune_differential_composition_relative_5.rds") |> replicate_data (~ 0 + tissue_harmonised)
...
# 		) |>
#
# 		saveRDS("~/PostDoc/cellNexus/dev/immune_non_immune_differential_composition_age2.rds")
#
# })
...
job::job({
		...
		sccomp_glm(
			...
			cores = 20,
			mcmc_seed = 42, verbose = T
		) |> saveRDS("~/PostDoc/cellNexus/dev/immune_non_immune_differential_composition_age_relative.rds")
})

# job::job({
# 	readRDS("~/PostDoc/cellNexus/dev/immune_non_immune_differential_composition_age_relative.rds") |>
# 		remove_unwanted_variation(~ age_days) |>
# 		saveRDS("~/PostDoc/cellNexus/dev/proportions_age_adjusted_relative.rds")
# 	})
# job::job({
# 	readRDS("~/PostDoc/cellNexus/dev/immune_non_immune_differential_composition_age2.rds") |>
# 		remove_unwanted_variation(~ age_days) |>
# 		saveRDS("~/PostDoc/cellNexus/dev/proportions_age_adjusted_absolute.rds")
# 	})
proportions_age5 = readRDS("~/PostDoc/cellNexus/dev/proportions_age_adjusted_relative.rds")
proportions_age_absolute = readRDS("~/PostDoc/cellNexus/dev/proportions_age_adjusted_absolute.rds")
