...
#> <div class="tabbable">
#>   <ul class="nav nav-tabs" data-tabsetid="8472">
#>     <li class="active">
#>       <a href="#tab-8472-1" data-toggle="tab" data-bs-toggle="tab" data-value="Personal">Personal</a>
#>     </li>
#>     <li>
#>       <a href="#tab-8472-2" data-toggle="tab" data-bs-toggle="tab" data-value="Settings">Settings</a>
#>     </li>
#>   </ul>
#>   <div class="tab-content" data-tabsetid="8472">
#>     <div class="tab-pane active" data-value="Personal" id="tab-8472-1">
#>       <div class="row">
#>         <div class="col-sm-6">
#>           <div class="form-group shiny-input-container">
...
#>       </div>
#>     </div>
#>     <div class="tab-pane" data-value="Settings" id="tab-8472-2">
#>       <div class="row">
#>         <div class="col-sm-6">
#>           <div class="form-group shiny-input-container">
#>             <div class="checkbox">
