...
``` r
get_metadata_url(
  databases = c("cellnexus_metadata.2.2.1.parquet", "census_cell_metadata.2.2.1.parquet")
)
```
...
#> https://object-store.rc.nectar.org.au/v1/AUTH_06d6e008e3e642da99d806ba3ea629c5/cellNexus-metadata/cellnexus_metadata.2.2.1.parquet
```
