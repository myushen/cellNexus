...
```
    ...
    #> ℹ Downloading https://object-store.rc.nectar.org.au/v1/AUTH_06d6e008e3e642da99d806ba3ea629c5/cellNexus-metadata/sample_metadata.2.0.0.parquet to /tmp/RtmpZXtWcY/sample_metadata.2.0.0.parquet
    #> # Source:   SQL [?? x 89]
...
#>  4 respiratory airway cd4 th2 em                
#>  5 lung               cd4 th1 em                
#>  6 nose               cd4 fh em                 
#>  7 respiratory airway granulocyte               
#>  8 blood              cd14 mono                 
#>  9 nose               cd4 tcm                   
#> 10 colonic epithelium nk                        
#> # ℹ more rows
```
...
#> ℹ Downloading https://object-store.rc.nectar.org.au/v1/AUTH_06d6e008e3e642da99d806ba3ea629c5/cellNexus-anndata/cellxgene/01-07-2024/counts/e52795dec7b626b6276b867d55328d9f___1.h5ad to /tmp/RtmpZXtWcY/cellxgene/01-07-2024//counts/e52795dec7b626b6276b867d55328d9f___1.h5ad
#> ℹ Reading files.
...
#>   "/tmp/RtmpZXtWcY/cellxgene/03-10-2025/counts"`.
#> Caused by warning:
...
#> [1] ggplot2_4.0.2     dplyr_1.2.0       cellNexus_0.99.12 BiocStyle_2.39.0 
#> 
...
#>  [57] spatstat.explore_3.7-0      Seqinfo_1.1.0              
#>  [59] duckdb_1.5.0                jsonlite_2.0.0             
#>  [61] progressr_0.18.0            ggridges_0.5.7             
...
#>  [73] MatrixGenerics_1.23.0       HDF5Array_1.39.0           
...
#> [101] SingleCellExperiment_1.33.1 XVector_0.51.0             
