...
`  credential_id     ``=`` `[`Sys.getenv`](https://rdrr.io/r/base/Sys.getenv.html)`(``"NECTAR_CREDENTIAL_ID"``)``,`\
`  credential_secret ``=`` `[`Sys.getenv`](https://rdrr.io/r/base/Sys.getenv.html)`(``"NECTAR_CREDENTIAL_SECRET"``)`\
`)`
